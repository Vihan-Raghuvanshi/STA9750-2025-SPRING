...
# Your existing code up to the dygraph creation...
# (all the data preparation code stays the same)
...
library(htmlwidgets)
saveWidget(ridership_plot, "mta_ridership_interactive.html", selfcontained = TRUE)
```
...
p
saveWidget(p, "mta_revenue_impact_interactive.html", selfcontained = TRUE)
```
...
saveWidget(plot_interactive, "mta_time_slot_ridership_interactive.html", selfcontained = TRUE)
```
